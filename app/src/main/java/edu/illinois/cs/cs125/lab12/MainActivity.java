...
public final class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
         ...
         */
        final ImageButton openFile = findViewById(R.id.file);
        ...
        final ImageButton downloadFile = findViewById(R.id.download);
        ...
        final ImageButton processImage = findViewById(R.id.upload);
